 ...
 * @method static void share(string|array<array-key, mixed>|\Heritage\Contracts\Support\Arrayable<array-key, mixed>|\Inertia\ProvidesInertiaProperties $key, mixed $value = null)
 ...
 * @method static \Inertia\Response render(\BackedEnum|\UnitEnum|string $component, array<array-key, mixed>|\Heritage\Contracts\Support\Arrayable<array-key, mixed>|\Inertia\ProvidesInertiaProperties $props = [])
 ...
 * @method static array<string, mixed> getFlashed(\Heritage\Http\Request|null $request = null)
 * @method static array<string, mixed> pullFlashed(\Heritage\Http\Request|null $request = null)
