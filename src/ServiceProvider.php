...
use Heritage\Contracts\Http\Kernel as HttpKernelContract;
use Heritage\Foundation\Http\Kernel;
use Heritage\Http\RedirectResponse;
use Heritage\Http\Request;
use Heritage\Routing\Router;
use Heritage\Support\ServiceProvider as BaseServiceProvider;
use Heritage\Testing\TestResponse;
use Heritage\View\FileViewFinder;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    /**
     * Register Scribe commands for managing Inertia middleware creation
